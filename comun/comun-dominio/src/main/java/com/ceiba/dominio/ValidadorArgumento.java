...
public class ValidadorArgumento {
    ...
    public static void validarValorMenorMatematico(BigDecimal valor, BigDecimal valorEstimado, String mensaje){
        if(valor.compareTo(valorEstimado) == -1){
    ...
    public static <T> void validarExistenciaDelRecurso(List<T> lista, String mensaje) {
        if (lista.isEmpty()) {
            throw new ExcepcionSinDatos(mensaje);
        }
    }
    public static void validarExistenciaDelRecurso(Object objeto, String mensaje) {
        if (objeto == null) {
            throw new ExcepcionSinDatos(mensaje);
        }
    }
